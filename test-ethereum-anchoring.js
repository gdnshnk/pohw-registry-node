/**
 * Test Ethereum Sepolia Anchoring
 * Tests anchoring with your actual wallet and Sepolia ETH
 */
...
async function testEthereumAnchoring() {
  console.log('🔗 Testing Ethereum Sepolia Anchoring\n');
  console.log('='.repeat(70));
  console.log('\n⚠️  Prerequisites:');
  console.log('   1. Server must be running with ANCHORING_ENABLED=true');
  console.log('   2. ETHEREUM_ENABLED=true');
  console.log('   3. ETHEREUM_PRIVATE_KEY set');
  console.log('   4. Wallet has Sepolia ETH\n');
  ...
  try {
    ...
    const proof = generateTestProof(`ethereum-anchor-test-${Date.now()}`);
    ...
    // Test anchoring
    console.log('\n4. Testing REAL Ethereum Sepolia anchoring...');
    console.log('   ⚠️  This will create a REAL transaction on Ethereum Sepolia!');
    console.log('   ⚠️  It will cost gas fees (~0.0001-0.001 ETH)\n');
    ...
    if (anchorResult.status === 200) {
      ...
      anchorResult.data.anchors.forEach((anchor, i) => {
        ...
        if (anchor.success) {
          ...
          console.log(`\n      🔗 View on explorer:`);
          if (anchor.chain === 'ethereum') {
            console.log(`         https://sepolia.etherscan.io/tx/${anchor.txHash}`);
          } else if (anchor.chain === 'bitcoin') {
      ...
      console.log(`      2. Set ETHEREUM_ENABLED=true`);
      console.log(`      3. Set ETHEREUM_PRIVATE_KEY=your_hex_key`);
    ...
    console.log('\n' + '='.repeat(70));
    console.log('\n✅ Ethereum anchoring test completed!');
    console.log('\n📝 Next Steps:');
    console.log('   - Check transaction on Sepolia explorer');
